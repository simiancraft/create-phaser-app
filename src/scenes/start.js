import DragonBonesPlugin from '../plugins/dragonbones';
...
import dragonbonesSkeleton from '../assets/dragonbones-test/Ubbie_ske.json';
import dragonbonesTexture from '../assets/dragonbones-test/Ubbie_tex.png';
import dragonbonesTextureMap from '../assets/dragonbones-test/Ubbie_tex.json';
...
export default class StartScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.dragonBones.load({
      name: 'ubbie',
      skeleton: dragonbonesSkeleton,
      texture: dragonbonesTexture,
      textureMap: dragonbonesTextureMap
    });
  }
  create() {
    this.add
