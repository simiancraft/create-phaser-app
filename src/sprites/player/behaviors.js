            ...
            states: {
                ...
                jumpPrepping: {
                    ...
                    _onEnter: function() {
                        as.sequence(`${directions.state}-crouchjumpprep`)
                            .then(() =>
                                as.sequence(`${directions.state}-crouchjump`)
                            )
                            .then(() => {
                ...
                flying: {
                    ...
                    land: function(data) {
                        ...
                        if (data.fallForce) {
                            ...
                            let shakeIntensity = shakeIntensityScale(
                                data.fallForce
                            );
                            let shakeDuration = shakeDurationScale(
                                data.fallForce
                            );
                ...
                landing: {
                    ...
                    _onEnter: function() {
                        as.sequence(`${directions.state}-crouch-up2dwn`)
                            .then(() =>
                                as.sequence(`${directions.state}-crouch-dwn2up`)
                            )
                            .then(() => {
                                this.transition('idling');
                            });
                ...
                sliding: {
                    _onEnter: function() {
                        ...
                        as.sequence(
                            `${directions.state}-slide-stand2slide`
                        ).then(() => {
                ...
                slidend: {
                    _onEnter: function() {
                        as.sequence(
                            `${directions.state}-slide-slide2stand`
                        ).then(() => {
                            this.transition('idling');
                        });
                    }
                ...
                shooting: {
                    ...
                    _onEnter: function() {
                        ...
                        as.sequence(
                            `${directions.state}-firecannon-${aims.state}`
                        ).then(() => {});
                    },
                    _onExit: function() {
                        this.emit('vulcanmuzzle', { on: false });
                ...
                walkshooting: {
                    ...
                    _onEnter: function() {
                        ...
                        as.sequence(
                            `${directions.state}-firecannonwalk-${aims.state}`
                        );
                    },
                    _onExit() {
                        this.emit('vulcanmuzzle', { on: false });
